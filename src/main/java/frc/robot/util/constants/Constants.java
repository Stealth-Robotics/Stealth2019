...
public class Constants
{
    ...
    public static final double DESIRED_TARGET_AREA = 20;          // Area of the target when the robot reaches the wall
    ...
    public static final double STEER_kP = 0.01;                    // how hard to turn toward the target
